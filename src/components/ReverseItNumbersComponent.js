...
export default function ReverseItNumbersComponent() {
  ...
  const [output, getOutput] = useState("The number [userinput] reversed [output]");
  const getResult = async () =>{
    const response = await ReverseItNumbersApi(num);
    getOutput(response);
  }
  return (
    <body class="backgroundReverseItNumbers">
    <div>
        <div class="grid grid-cols-12">
            ...
            <div class="col-span-8 text-center mt-[3.8125rem] mb-[3.4376rem]">
                <p class="font-[Rubik-Bold] text-[3.125rem] lg:text-[5rem] text-white">Reverse It (Integer)</p>
            </div>
        </div>
        <div>
        ...
        <div class="flex justify-center">
            <p class="text-[1.875rem] lg:text-[3.125rem] font-[Rubik-Bold] mt-[1.25rem] lg:mt-[5.25rem]">Enter a NUMBER</p>
        </div>
