      ...
      <div>
        <div className="grid grid-cols-12">
          ...
          <div className="col-span-8 text-center mt-[3.8125rem] mb-[3.4376rem]">
            <p className="font-[Rubik-Bold] text-[3.125rem] lg:text-[5rem] text-white">Reverse It (String)</p>
          </div>
        </div>
        <div>
        ...
        <div className="flex justify-center px-[1.9375rem]">
          <div
            ...
            <p className="font-[Rubik-Bold] text-[1.875rem] lg:text-[4.375rem] text-center p-5 lg:p-20" id="returnOutput">{output}</p>
          </div>
        </div>

        <div className="flex justify-center">
          <p className="text-[1.875rem] lg:text-[3.125rem] font-[Rubik-Bold] mt-[1.25rem] lg:mt-[5.25rem]">Enter a word!</p>
        </div>
        ...
        <div className="flex justify-center px-[2.125rem] ">
          <input
            ...
            type="text" placeholder="Input" onChange={(e) => getString(e.target.value)} value={string} />
        </div>
