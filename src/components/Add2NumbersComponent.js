...
import { AddNumApi } from '../services/DataServices'
...
export default function Add2NumbersComponent() {
    ...
    const getResult = async () => {
        if (num1 === "" || num2 === "") {
            ...
            const response = await AddNumApi(num1, num2);
            setOutput(response);
        }

    }
    return (
        <body class="backgroundAdd2Nums">
            <div>
                <div class="grid grid-cols-12">
                    ...
                    <div class="col-span-8 text-center mt-[3.8125rem] mb-[3.4376rem]">
                        <p class="font-[Rubik-Bold] text-[3.125rem] lg:text-[5rem] text-white">Add 2 Numbers</p>
                    </div>
                </div>
                <div>
                ...
                <div class="flex justify-center">
                    <p class="text-[1.875rem] lg:text-[3.125rem] font-[Rubik-Bold] mt-[1.25rem] lg:mt-[5.25rem]">Enter 2
                        Numbers!</p>
                </div>
