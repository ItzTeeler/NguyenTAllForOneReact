      ...
      <div>
        <div className="grid grid-cols-12">
          ...
          <div className="col-span-8 text-center mt-[3.8125rem] mb-[3.4376rem]">
            <p className="font-[Rubik-Bold] text-[3.125rem] lg:text-[5rem] text-white">Greater Than or Less Than</p>
          </div>
        </div>
        <div>
        ...
        <div className="flex justify-center px-[1.9375rem]">
          <div
            className="bg-white w-[77.5rem] min-h-[24.25rem] border-black rounded-[20px] border-[0.3125rem] grid justify-center items-center grid-cols-12">
            <p className="font-[Rubik-Bold] text-[1.875rem] lg:text-[4.375rem] text-center col-span-12 p-5 lg:p-20" > {output}</p>
          </div>
        </div>

        <div className="flex justify-center">
          <p className="text-[1.875rem] lg:text-[3.125rem] font-[Rubik-Bold] mt-[1.25rem] lg:mt-[5.25rem]">Enter 2 Numbers!</p>
        </div>
