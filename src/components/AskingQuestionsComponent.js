    ...
    <div>
        <div className="grid grid-cols-12">
            ...
            <div className="col-span-8 text-center mt-[3.8125rem] mb-[3.4376rem]">
                <p className="font-[Rubik-Bold] text-[3.125rem] lg:text-[5rem] text-white">Asking Questions</p>
            </div>
        </div>
        <div>
        ...
        <div className="grid grid-cols-4 px-[2.125rem] lg:px-44">
            <div className="col-span-4 lg:col-span-2 order-1">
                <p
                    className="text-[1.875rem] lg:text-[3.125rem] font-[Rubik-Bold] mt-[1.25rem] lg:mt-[5.25rem] text-center">
                    Your Name</p>
            </div>
