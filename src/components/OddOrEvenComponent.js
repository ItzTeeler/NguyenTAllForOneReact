...
export default function OddOrEvenComponent() {
  ...
  const [output, getOutput] = useState("The number [userinput] is Odd/Even");
  const getResult = async ()=>{
    const response = await OddOrEvenApi(num1);
    getOutput(response)
  }
  return (
    <body class="backgroundOddorEven">
    <div>
        <div class="grid grid-cols-12">
            ...
            <div class="col-span-8 text-center mt-[3.8125rem] mb-[3.4376rem]">
                <p class="font-[Rubik-Bold] text-[3.125rem] lg:text-[5rem] text-white">Odd Or Even</p>
            </div>
        </div>
        <div>
